...
const (
	...
	EventService_PollPendingEvents_FullMethodName = "/event.v1.EventService/PollPendingEvents"
	EventService_UpdateEventStatus_FullMethodName = "/event.v1.EventService/UpdateEventStatus"
...
type EventServiceClient interface {
	...
	PollPendingEvents(ctx context.Context, in *PollPendingEventsRequest, opts ...grpc.CallOption) (*PollPendingEventsResponse, error)
...
func (c *eventServiceClient) PollPendingEvents(ctx context.Context, in *PollPendingEventsRequest, opts ...grpc.CallOption) (*PollPendingEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PollPendingEventsResponse)
	err := c.cc.Invoke(ctx, EventService_PollPendingEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventServiceServer interface {
	...
	PollPendingEvents(context.Context, *PollPendingEventsRequest) (*PollPendingEventsResponse, error)
...
func (UnimplementedEventServiceServer) PollPendingEvents(context.Context, *PollPendingEventsRequest) (*PollPendingEventsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PollPendingEvents not implemented")
}
...
func _EventService_PollPendingEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PollPendingEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).PollPendingEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_PollPendingEvents_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).PollPendingEvents(ctx, req.(*PollPendingEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PollPendingEvents",
			Handler:    _EventService_PollPendingEvents_Handler,
		},
		{
